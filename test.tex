...
\begin{enumerate}
\item Please follow the tutorial and install RTEMS on your computer. Then upload the generated kernel on Raspberry Pi to execute. We suggest you to take a look in RTEMS.
